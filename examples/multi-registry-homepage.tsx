  ...
  return (
    <div className="bg-card relative flex flex-col rounded-lg border p-6 shadow-sm">
      ...
      <div className="flex-1">
        <h4 className="mb-2 text-sm font-medium">Components Preview</h4>
      ...
      <div className="mt-4 space-y-2">
        <div className="bg-muted/50 rounded p-3">
          <p className="mb-1 text-xs font-medium">Installation</p>
          <code className="text-xs break-all">
            npx shadcn@latest add component-name --registry
            https://yourdomain.com/{registry.name}
          </code>
        </div>
    ...
    <div className="mx-auto flex min-h-svh max-w-6xl flex-col gap-8 px-4 py-8">
      ...
      <main className="flex flex-1 flex-col gap-8">
        {featuredRegistries.length > 0 && (
          <section>
            <h2 className="mb-4 text-2xl font-semibold">Featured Registries</h2>
        ...
        {otherRegistries.length > 0 && (
          <section>
            <h2 className="mb-4 text-2xl font-semibold">All Registries</h2>
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <section className="bg-muted/30 rounded-lg p-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              <h3 className="mb-2 font-medium">Install Components</h3>
              <p className="text-muted-foreground mb-2 text-sm">
                Use the shadcn CLI to install components from any registry:
              </p>
              <code className="bg-background block rounded border px-2 py-1 text-sm">
                npx shadcn@latest add button --registry
                https://yourdomain.com/registry-name
              </code>
            </div>
            <div>
              <h3 className="mb-2 font-medium">Browse & Discover</h3>
              <p className="text-muted-foreground mb-2 text-sm">
